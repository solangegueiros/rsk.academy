...
export interface AcademyStudentQuizInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getStudentQuiz",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "countStudentByQuiz",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "countQuizByStudent",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "listStudentByQuiz",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "listQuizByStudent",
    values: [string]
  ): string;
