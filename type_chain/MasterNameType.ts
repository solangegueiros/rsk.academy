...
export interface MasterNameInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addName",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "addNameBySC",
  ...
  encodeFunctionData(
    functionFragment: "deleteNameBySC",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "existsScName",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "checkName",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "listNameInfo",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "countNames",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getNameInfoByOwner",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getNameInfoByNameSC",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getNameInfoByIndex",
    values: [BigNumberish]
  ): string;
...
export class MasterName extends BaseContract {
  ...
  getNameInfoByOwner(
    ...
    [string, string, string] & { owner: string; scName: string; name: string }
  >;
  ...
  filters: {
    NameAdded(
      ...
      [string, string, string],
      { owner: string; scName: string; name: string }
    >;
