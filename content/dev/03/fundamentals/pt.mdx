...
Em grego: _kryptós_, "escondido", e *gráphein*, "escrita"
...
A função hash SHA-256 é utilizada na rede Bitcoin essencialmente em duas maneiras:
...
Os diagramas de Paul Baran, publicados no texto _On distributed communications_ (BARAN, Paul - 1964)
...
Na próxima lição você conhecerá alguns algoritmos de consenso.
